        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('management.fee-plans.store') }}" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <x-text-input id="cycle_fee_rm" name="cycle_fee_rm" class="block mt-1 w-full" type="number" step="0.01" :value="old('cycle_fee_rm')" required />
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div>
                                ...
                                <x-text-input id="lessons_per_cycle" name="lessons_per_cycle" class="block mt-1 w-full" type="number" :value="old('lessons_per_cycle', 4)" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="minutes_per_lesson_default" name="minutes_per_lesson_default" class="block mt-1 w-full" type="number" :value="old('minutes_per_lesson_default', 60)" required />
                        ...
                        <div class="flex items-center gap-6">
                            <label class="inline-flex items-center gap-2">
                                <input type="checkbox" name="allow_half_hour" value="1" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" @checked(old('allow_half_hour')) />
